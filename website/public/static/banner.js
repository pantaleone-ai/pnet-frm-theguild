...
function main() {
  ...
  function toggleModal() {
    // Get the modal
    const modal = document.getElementById('ossModal');

    // Get the <span> element that closes the modal
    const span = document.getElementsByClassName('g-close')[0];
  ...
  function bindModal() {
    ...
    const btn = document.getElementById('oss-nav');
  ...
  function init() {
    const guildHeader = htmlToElements(/* HTML */ `
      <style type="text/css">
        #g-header-bar {
        ...
        <div class="g-modal-content">
          ...
          <div class="productTable" align="center">
            ...
            <div class="flex-item-right">
              ...
              <div class="ossContentCells">
                <a href="https://www.the-guild.dev/graphql/config" target="_blank">
